...
#     directions:
#
#         River's Rest / Torre             town   / county
#         Brisker's Cove / Seareach        town   / county
...
#
#         Zul Logoth / Kharag 'doth Dzulthu   ONE place, named twice
#
#     Four of those are place-then-container, so the direction looks
#     small-to-large until it isn't: `Teras / Kharam Dzu` is the other way
#     round, the Transport ones are not containment at all, and Zul Logoth
#     and Kharag 'doth Dzulthu are the common and dwarven names of the
#     SAME dwarven settlement, beneath the Dragon Spine Mountains. Three
#     different relations behind one character.
#
#     The Zul Logoth case is the one that punishes reading the data
#     instead of asking. Its 1,280 rooms are the settlement (584) plus
#     The Hive, Stormpeak, the Czeroth Caverns, the Zaerthu Tunnels, the
#     Mraent Caverns and the Troll Burial Grounds, which looks exactly
#     like a town inside a cave system that the second name must denote.
#     It is not: the caves are simply what surrounds a settlement that
#     happens to be underground, and the container -- the Dragon Spine
#     Mountains -- is not in the string at all.
#
#     Only 12 of the 72 have a slash at all, and
